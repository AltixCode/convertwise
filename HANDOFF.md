...
| | State | Id |
|---|---|---|
| Bundle id registered | ✅ | `com.altixcode.convertwise` |
| App Store Connect record | ✅ | `6812380174` — store name "Convertwise" |
...
| AdMob app — iOS | ✅ | `ca-app-pub-2504845459806550~6293155532` |
| AdMob app — Android | ✅ | `ca-app-pub-2504845459806550~2638560567` |
| AdMob ad units (6) | ✅ | iOS banner/interstitial/rewarded `6686898046` / `4060734700` / `5022462589`; Android `6143972565` / `4217656533` / `4830890899` |
...
| RevenueCat project, apps, entitlement, offering | ✅ | project `proj14c4c30d`, entitlement `entlf41f6a9691`, offering `ofrng72fcb4cc2b` |
