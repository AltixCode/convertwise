...
`apps.json`). Fix it there and re-run `node scripts/bootstrap.mjs convertwise`,
...
| | |
|---|---|
| Bundle id / package | `com.altixcode.convertwise` |
| Scheme | `convertwise://` |
| RevenueCat entitlement | `remove_ads` |
| RevenueCat package | `$rc_lifetime` |
| iOS product | `com.altixcode.convertwise.removeads` |
| Android product | `remove_ads` |
| GitHub | `AltixCode/convertwise` |
