#!/usr/bin/env node
/**
 * Generates every brand asset for Convertwise from one source of truth: the mark below.
 *
 ...
 */
const SHAPES = [{"type":"path","points":[[0.14,0.33],[0.66,0.33]],"w":0.11,"fill":"accent"},{"type":"poly","points":[[0.62,0.19],[0.9,0.33],[0.62,0.47]],"fill":"accent"},{"type":"path","points":[[0.86,0.67],[0.34,0.67]],"w":0.11,"fill":"accentMid"},{"type":"poly","points":[[0.38,0.53],[0.1,0.67],[0.38,0.81]],"fill":"accentMid"}];
 ...
 */
const MARK = [[0.12,1,1,1,0.12],[1,0.12,0.12,0.12,0.12],[0.12,0.45,1,0.45,0.12],[0.12,0.12,0.12,0.12,1],[0.12,1,1,1,0.12]];
...
console.log('Generating Convertwise brand assets\n');
